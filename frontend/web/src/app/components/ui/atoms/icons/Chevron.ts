...
import { IconDirection, ROTATION_MAP } from './icons.types';
...
@Component({
  ...
  template: `
    ...
    >
      <g [attr.transform]="'rotate(' + rotation() + ' 256 256)'">
        <path
          [attr.fill]="color()"
          d="M256,469.504c-3.458,0-6.914-1.202-9.7-3.605L5.152,257.918C1.882,255.097,0,250.99,0,246.671V57.349
        ...
        <polygon
          [attr.fill]="fillColor()"
          points="256,454.652 497.147,246.671 497.147,57.349 256,265.329 255.942,265.28 146.586,359.595"
        />
        <path
          [attr.fill]="color()"
          d="M256,469.504c-3.474,0-6.948-1.213-9.742-3.64l-109.414-95.056c-3.254-2.826-5.12-6.929-5.111-11.239
...
export class Chevron {
  ...
  color = input<string>('var(--tertiary)');
  direction = input<IconDirection>('right');
  fillColor = input<string>('var(--quaternary)');
