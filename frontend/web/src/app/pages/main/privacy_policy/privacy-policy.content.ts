...
export const PRIVACY_POLICY_CONTENT: PrivacyPolicyContent = {
    ...
    tableOfContents: [
        { number: 1, id: 'summary', title: 'Summary' },
        { number: 2, id: 'scope', title: 'Scope of This Policy' },
        { number: 3, id: 'information-we-collect', title: 'Information We Collect' },
        { number: 4, id: 'information-we-do-not-collect', title: 'Information We Do Not Collect' },
        { number: 5, id: 'how-we-use-information', title: 'How We Use Information' },
        { number: 6, id: 'ai-voice-receipt', title: 'AI, Voice Input, and Receipt Scanning' },
        { number: 7, id: 'how-we-share-information', title: 'How We Share Information' },
        { number: 8, id: 'cookies-storage', title: 'Cookies, Local Storage, and Similar Technologies' },
        { number: 9, id: 'data-retention', title: 'Data Retention' },
        { number: 10, id: 'security', title: 'Security' },
        { number: 11, id: 'your-choices', title: 'Your Choices and Privacy Rights' },
        { number: 12, id: 'regional-disclosures', title: 'Regional Privacy Disclosures' },
        { number: 13, id: 'childrens-privacy', title: "Children's Privacy" },
        { number: 14, id: 'international-transfers', title: 'International Data Transfers' },
        { number: 15, id: 'third-party-links', title: 'Third-Party Links and Services' },
        { number: 16, id: 'changes', title: 'Changes to This Policy' },
        { number: 17, id: 'contact-us', title: 'Contact Us' }
    ],
    sections: [
        {
            id: 'summary',
