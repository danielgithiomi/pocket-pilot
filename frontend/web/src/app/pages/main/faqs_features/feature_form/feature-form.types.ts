...
export const suggestFeatureSchema = schema<FeatureSchema>((root) => {
    ...
    minLength(root.featureTitle, 10, { message: 'The feature title must be at least 10 characters long!' });

    // FEATURE CONTENT
    required(root.featureContent, { message: 'The feature content is required field!' });
    minLength(root.featureContent, 20, { message: 'The feature content must be at least 20 characters long!' });
