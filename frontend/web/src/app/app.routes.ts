        ...
        loadChildren: () => [
            {
                ...
                loadComponent: () =>
                    import('@pages/main/onboarding/onboarding').then((m) => m.Onboarding),
            },
        ],
    },
    {
        ...
        loadChildren: () => [
            {
                ...
                loadComponent: () =>
                    import('@pages/main/dashboard/dashboard').then((m) => m.Dashboard),
            },
            {
            ...
            },
            {
                ...
                loadComponent: () =>
                    import('@pages/main/accounts/accounts').then((m) => m.Accounts),
            },
            {
                title: 'Account Details | Pocket Pilot',
                path: WEB_ROUTES.accountDetails,
                loadComponent: () =>
                    import('@pages/main/account_details/account-details').then(
                        (m) => m.AccountDetails,
                    ),
            },
            {
            ...
            },
            {
                ...
                loadComponent: () =>
                    import('@pages/main/splitr_details/splitr-details').then(
                        (m) => m.SplitrDetails,
                    ),
            },
            {
