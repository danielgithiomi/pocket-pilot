...
export type NotificationCategory = 'BILL' | 'BUDGET' | 'TRANSACTION' | 'ACCOUNT' | 'GOAL' | 'SECURITY' | 'SYSTEM';
...
export type NotificationFilter = 'all' | 'unread' | 'action_required' | Lowercase<NotificationCategory>;
...
export interface NotificationEventPayload {
	eventType: 'NOTIFICATION_CREATED' | 'NOTIFICATION_UPDATED' | 'NOTIFICATIONS_REFRESHED';
